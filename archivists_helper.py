...
class LogWriter:
    ...
    def csv_writer(
        ...
        with open(self.log_file, mode="a", newline="") as f:
            ...
            permitted_actions = ['INGEST_FILE', 'COMPUTE_CHECKSUM', 'EXTRACT_METADATA', 'NORMALISE_FILENAME', 'NORMALISE_METADATA', 'CREATE_DIRECTORY', 'MOVE', 'CREATE_BAG', 'VALIDATE_BAG']
            ...
            writer.writerow(
                [
                    ...
                    path_after,
                    hash_before,
                    self.calculate_sha256(path_after),
                ]
            )
            f.flush()
